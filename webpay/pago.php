...
/****************** FIN CONFIGURACION *****************/ //formato Moneda
...
<body>
    <form action="<?php echo $url_cgi; ?>" name="frm" method="post">
        <table>
            ...
            <tr>
                <td align="right">TBK_ID_SESSION:</td>
                <td><input type="text" name="TBK_ID_SESION" value="<?php echo $TBK_ID_SESION;?>"/></td> </tr>
            <tr>
                <td align="right">Pagina de EXITO:</td>
                <td><input type="text" name="TBK_URL_EXITO" value="<?php echo $TBK_URL_EXITO;?>"/></td>
            </tr>
            <tr>
                <td align="right">Pagina de Fracaso:</td>
